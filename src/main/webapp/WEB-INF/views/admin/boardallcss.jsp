	...
	<div class="bg-color-sky-light" data-auto-height="true">
		<div class="content-lg container" style="margin-top : 50px;">
			...
			<div class="content-lg container">
				...
				<div class="mt-10">
					<h2>
						<i class="fas fa-list title_subject_icon" style="margin-right : 10px;"></i>CSS3
					</h2>
					<div class="table-responsive">
						<table id="foo-table" class="table table-striped">
							...
							<c:choose>
		                    	<c:when test = "${boardallcss != null and fn:length(boardallcss) > 0 }">
		                    		<c:forEach var="board" items="${boardallcss}">
				                        <tr>
				                            <td>${board.post_id }</td>
				                            <td>
