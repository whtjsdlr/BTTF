				...
				<div class="mt-10">
					...
					<div class="table-responsive">
						<table id="foo-table" class="table table-striped">
							...
							<tbody>
								<c:choose>
			                    	<c:when test = "${boardallspring != null and fn:length(boardallspring) > 0 }">
			                    		<c:forEach var="board" items="${boardallspring}">
					                        <tr>
					                            <td>${board.post_id }</td>
					                            <td>
					                            	<a href="/board/springview?post_id=${board.post_id }">${board.post_subject }</a>
					                            </td>
