	...
	<div class="bg-color-sky-light" data-auto-height="true">
		<div class="content-lg container" style="margin-top : 50px;">
			...
			<div class="content-lg container">
				...
				<div class="mt-10">
					<h2>
						<i class="fas fa-list title_subject_icon" style="margin-right : 10px;"></i>JAVASCRIPT
					</h2>
					<div class="table-responsive">
						<table id="foo-table" class="table table-striped">
							...
							<tbody>
								<c:choose>
			                    	<c:when test = "${boardalljs != null and fn:length(boardalljs) > 0 }">
			                    		<c:forEach var="board" items="${boardalljs}">
					                        <tr>
					                            <td>${board.post_id }</td>
					                            <td>
					                            ...
					                            <td><fmt:formatDate pattern="yyyy-MM-dd" value="${board.post_regdate }"/></td>
					                        </tr>
			                        	</c:forEach>
			                        </c:when>
			                        <c:otherwise>
