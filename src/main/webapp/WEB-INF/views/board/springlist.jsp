    ...
    <div class="bg-color-sky-light fixed_container" style="min-height: 100vh;">
        <div class="content-lg container" style="margin-top : 50px;">
            ...
            <form>
	            <div class="table-responsive">
	                <table id="foo-table" class="table table-striped" data-order='[[ 0, "desc" ]]'>
	                    ...
	                    <tbody>
	                    	<c:choose>
			                    <c:when test = "${springlist != null and fn:length(springlist) > 0 }">
			                    		<c:forEach var="board" items="${springlist}">
					                        <tr>
					                            <td>${board.post_id }</td>
					                            <td>
			...
			<c:if test="${member != null }">
           		<a href="/board/springwrite"class="btn btn-primary" type="submit">글쓰기</a>
            </c:if>
 		</div>
	 </div>
