...
<body class="page-on-scroll ">
                    ...
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                        <div class="my_box" data-height="height">
                            <form method="post">
                                ...
                                <div>
                                    <pre class="form-control" placeholder="내용을 입력해 주세요." style="height : 650px; resize: none; background-color: #fff;" disabled>${javaview.post_contents }</pre>
                                </div> 
	...
	function showList(page) {
			var postValue = '<c:out value="${javaview.post_id }"/>'
			var board_category_idValue = '<c:out value="${javaview.board_category_id}"/>'
