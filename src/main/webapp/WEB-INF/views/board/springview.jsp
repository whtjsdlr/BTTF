                        ...
                        <div class="my_box" data-height="height">
                            <form method="post">
                                <div class="col-md-6">
									...
									<input type="hidden" name="post_id" id = "post_id" value="${springview.post_id }">
	                            ...
	                            <div class="card-body">
									...
									<c:if test="${member != null }">
		                                <form id="replyForm" name="replyForm" method="post" class="mb-4 d-flex col-md-12 p-0" target=detail onsubmit="all_reset();">
		                                	...
		                                	<input type="hidden" id="board_category_id" name="board_category_id" value="${springview.board_category_id}">
	...
	<div class="modal fade" id="memberreport" tabindex="-1" role="dialog" aria-labelledby="memberreport" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form name="Check" action="/board/springreport" id="reportForm" method ="get" >
					<input type="text" style="display:none;" name="reportee_index" id="reportee_index" value="${springview.user_index }">
					<input type="text" style="display:none;" name="reporter_index" id="reporter_index" value="${member.user_index }">
					<input type="text" style="display:none;" name="board_category_id" id="board_category_id" value="${springview.board_category_id }">
					<input type="text" style="display:none;" name="post_id" id="post_id" value="${springview.post_id }">
	...
	function showList(page) {
		...
		function updateviewBtn(board_category_id, reply_id, reply_regdate, reply_contents,user_nickname) {
			var updatestr = "";
				...
				updatestr += "<c:if test='${member.user_nickname eq springview.user_nickname}'>";
