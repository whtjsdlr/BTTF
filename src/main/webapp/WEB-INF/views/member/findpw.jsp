            ...
            <div class="card align-middle col-md-3 login_card" >
                ...
                <div class="card-body">
                    <form class="form-signin" method="POST">
                        <input type="email" name="user_email" id="user_email" class="form-control" placeholder="이메일" style="margin-bottom : 48px; border-radius:10px; height : 55px;" autofocus required>
                        ...
                        <input id="btn-Yes" class="btn btn-lg btn-primary btn-block" type="submit" style="line-height:28px !important; margin-bottom: 20px;" value="비밀번호찾기" >
                    </form>
                </div>
                <div class="links" style="padding: 10px 20px;">
                    <a href="/member/findid">이메일 찾기</a> | <a href="/member/signin"">로그인</a> | <a href="/member/signup">회원가입</a>
                </div>
            </div>
        </div>
    </div> 
